<?php
    ...
    if(isset($_POST['submit'])){
        ...
        $count = "select * from bangnhapzl where ngaythang like '$jw%'";
        $dem = $conn->query($count);

        $sql = "INSERT INTO `bangnhapzl`(`ngaythang`, `tongsokhachtuvan`, `hieuqua`, `khonghieuqua`, `dathen`) VALUES ('$date','$tongsokhachtuvan','$hieuqua','$khonghieuqua','$dathen')";
...
<?php
    if($dem->num_rows >0){
            ...
            header('Location:../index.php?page=addform&form=formzl');
            die;
    ...
    header("Refresh:2; url=../index.php?page=addform&form=formzl");
    }
?>
<html>
    <head>
