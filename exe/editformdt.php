<?php
    ...
    if(isset($_POST['submit'])){
       ...
       $sql = "UPDATE `bangnhapdt` SET `ngaythang`='$jw',`tongsokhachtuvan`='$tongsokhachtuvan',`hieuqua`='$hieuqua',`khonghieuqua`='$khonghieuqua',`dathen`='$dathen',`adwords`='$adwords',`facebook`='$facebook',`seo`='$seo' WHERE id='$idbangnhap'";
...
<?php
    ...
    header("Refresh:2; url=../index.php?view=dienthoai");
