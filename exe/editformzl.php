<?php
    ...
    if(isset($_POST['submit'])){
       ...
       $sql = "UPDATE `bangnhapzl` SET `ngaythang`='$jw',`tongsokhachtuvan`='$tongsokhachtuvan',`hieuqua`='$hieuqua',`khonghieuqua`='$khonghieuqua',`dathen`='$dathen' WHERE id='$idbangnhap'";
...
<?php
    ...
    header("Refresh:2; url=../index.php?view=zalo");
