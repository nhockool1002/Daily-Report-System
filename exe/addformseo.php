<?php
    ...
    if(isset($_POST['submit'])){
        ...
        $count = "select * from bangnhapseo where ngaythang like '$jw%'";
        $dem = $conn->query($count);

        $sql = "INSERT INTO `bangnhapseo`(`ngaythang`, `tongsokhachtuvan`, `hieuqua`, `khonghieuqua`, `dathen`) VALUES ('$date','$tongsokhachtuvan','$hieuqua','$khonghieuqua','$dathen')";
...
<?php
    if($dem->num_rows >0){
            ...
            header('Location:../index.php?page=addform&form=formseo');
            die;
    ...
    header("Refresh:2; url=../index.php?page=addform&form=formseo");
    }
?>
<html>
    <head>
